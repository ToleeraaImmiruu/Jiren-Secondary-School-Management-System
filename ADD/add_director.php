...
$_SESSION['add_role']=$role = "director";
...
header("location: ../signUp.php");
   ...
   if ($role == "student") {
        header("location: ../forms/student_form.php");
        $_SESSION['add_user']="STUDENT IS SUCCESFULLY ADDED";
    } else if ($role == "teacher") {
        header("location: ../forms/teacher_form.php");
        $_SESSION['add_user']="TEACHER IS SUCCESFULLY ADDED";
    } else if ($role == "director") {
        header("location: ./director_db.php");
        $_SESSION['add_user']="DIRECTOR IS SUCCESFULLY ADDED";
