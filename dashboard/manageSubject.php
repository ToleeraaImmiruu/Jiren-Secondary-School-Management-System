...
<td>".$data_9['grade']."</td>
<td><a href='./edit_subject.php? sub_code={$data_9['subject_code']}'><img class='edit' width='20' height='20' src='../images/edit.svg'></a></td>
<td><a href='../databases/delete_subject_check.php? sub_code={$data_9['subject_code']}'><img class='delete' width='20' height='20' src='../images/delete.svg'></a></td></tr>";
}
echo"</table>";
...
<td>".$data_10['grade']."</td><td><a href='./edit_subject.php? sub_code={$data_10['subject_code']}'><img class='edit' width='20' height='20' src='../images/edit.svg'></a></td>
<td><a href='../databases/delete_subject_check.php? sub_code={$data_10['subject_code']}'><img class='delete' width='20' height='20' src='../images/delete.svg'></a></td></tr>";
}
echo"</table>";
...
<td>".$data_11['grade']."</td>
<td>".$data_11['stream']."</td><td><a href='./edit_subject.php? sub_code={$data_11['subject_code']}'><img class='edit' width='20' height='20' src='../images/edit.svg'></a></td>
<td><a href='../databases/delete_subject_check.php? sub_code={$data_11['subject_code']}'><img class='delete' width='20' height='20' src='../images/delete.svg'></a></td></tr>";
}
echo"</table>";
...
<td>".$data_12['grade']."</td>
<td>".$data_12['stream']."</td><td><a href='./edit_subject.php? sub_code={$data_12['subject_code']}'><img class='edit' width='20' height='20' src='../images/edit.svg'></a></td>
<td><a href='../databases/delete_subject_check.php? sub_code={$data_12['subject_code']}'><img class='delete' width='20' height='20' src='../images/delete.svg'></a></td></tr>";
}
echo"</table>";
?>
</div>
