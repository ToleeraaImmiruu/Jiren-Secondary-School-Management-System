...
<body>
 ...
 session_start();
$_SESSION['id']=$_GET['id'];
if(isset($_SESSION['invalid_role'])){
echo("<h3>".$_SESSION['invalid_role']." !</h3>");
}
?>
<div class="container">
<h1>EDIT USER</h1>
<form action="../databases/edit_db.php" method="post" enctype="multipart/form-data" id="signupForm">
...
<input type="text" id="role" name="role" value="teacher">
